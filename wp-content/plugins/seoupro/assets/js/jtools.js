...
schemas = [
    ...
    // Organization [1]
    { title: 'Organization', jsonld: orgSchemaMarkup, schemaItems: [
            {
                required: true,
                info: '<p>Company Name</p>',
                property: 'name',
            ...
            {
                required: true,
                info: '<p>Legal Name of Company</p>',
                property: 'legalName',
                placeholder: 'Legal name',
                title: 'Company Legal Name:',
                macro: '#companyLegalName',
                type: 'string'
            },
            {
                required: true,
                info: '<p>Company Website URL</p>',
                property: 'url',
            ...
            {
                required: true,
                info: '<p>Company Logo URL - Enter a URL or use the button provided.</p>',
                property: 'logo',
                placeholder: 'Company Logo Image URL',
                title: 'Company Logo URL:',
                macro: '#companyLogoURL',
                type: 'logoimg'
            },
            {
                required: true,
                info: '<p>Company Street Address</p>',
                property: 'address.streetAddress',
            ...
            {
                required: true,
                info: '<p>Company State - Abbreviation</p>',
                property: 'address.addressRegion',
                placeholder: 'State',
                title: 'State:',
                macro: '#companyState',
            ...
            {
                required: true,
                info: '<p>Company Country</p>',
                property: 'address.addressCountry',
                placeholder: 'Zip Code - Postal Code',
                title: 'Country:',
                macro: '#companyCountry',
                type: 'country',
                choices: countries
            },
            {
                required: true,
                info: '<p>Contact For Company - Type of Contact</p>',
                property: 'contactType',
                placeholder: 'Type of contact',
                title: 'Contact Type For Company:',
                macro: '#contactType',
                type: 'combo',
                choices: contactPt
            },
            ...
            {
                required: true,
                info: '<p>Contact Type For Company</p>',
                property: 'contactType',
                placeholder: 'Type of contact',
                title: 'Contact Type For Company - (This contact is optional):',
                macro: '#contactTypeb',
                type: 'combo2',
                choices: contactPt
            },
            ...
            [
                {
                    ...
                    info: '<p>Array of one or two <a href="http://schema.org/SearchAction" target="_blank">SearchAction</a> objects</p><p>This object describes the URI to send the query to, and the syntax of the request that is sent.</p><p class="ns-notes"><br /><span class="codefont">@type:SearchAction</span><br />is used</p>',
    ...
    { title: 'Article', jsonld: articleSchemaMarkup, schemaItems: [

            {
                required: true,
                title: 'Article Type: ',
                info: '<p>Article objects must be based on one of the following schema.org types: <a href="http://schema.org/Article" target="_blank">Article</a>, <a href="http://schema.org/NewsArticle" target="_blank">NewsArticle</a>, <a href="http://schema.org/BlogPosting" target="_blank">BlogPosting<a/>.</p>',
                property: 'schemaType',
            ...
            },
            {
                ...
                info: '<p>The date the article was first published</p>',
                property: 'datePublished',
            ...
            },
            {
                ...
                info: '<p>The date the article was was most recently modified</p>',
    ...
    { title: 'Video', jsonld: VideoSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p>The date the video was first published, YYYY-MM-DD</p>',
                property: 'uploadDate ',
    ...
    ,
    // webpage[10]
    { title: 'Web Page', jsonld: webPage, schemaItems: [

            {
                required: true,
                title: 'Web Page Title: ',
                info: '<p>Title of this Web Page and Description of page.</p>',
                property: 'name',
            ...
            },
            {
                required: true,
                title: 'Description:',
                info: 'The description of this page.',
                property: 'description',
                placeholder: 'Description of this page.',
                macro: '#webPageDescription',
                type: 'string'
            }
    ...
    { title: 'QA Page', jsonld: QASchemaMarkup, schemaItems: [
            ...
            {
                required: false,
                info: '<p>The date at which the question was added to the page, YYY-MM-DD</p>',
    ...
    */
    ...
    { title: 'Dataset', jsonld: DataSetSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p>A license under which the dataset is distributed. This should be a URL to the actual license.</p>',
                property: 'license',
    ...
    { title: 'Event', jsonld: EventSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p>The start date of the event</p>',
                property: 'startDate',
                placeholder: 'Event Start Date YYYY-MM-DD',
            ...
            {
                required: true,
                info: '<p>The end date of the event.</p>',
                property: 'endDate',
    ...
    { title: 'Job Posting', jsonld: JobPostingSchemaMarkup, schemaItems: [
            ...
            },
            {
                ...
                property: 'datePosted',
                placeholder: 'Job Posting Date YYYY-MM-DD',
            ...
            {
                required: true,
                info: '<p>The date when the job posting will expire.</p>',
                property: 'validThrough',
                placeholder: 'Job Posting valid until Date YYYY-MM-DD',
    ...
    { title: 'Live Stream', jsonld: liveStremSchemaMarkup, schemaItems: [
            ...
            {
                required: true,
                info: '<p>Datewhen the livestream starts</p>',
                property: 'startDate',
            ...
            {
                required: true,
                info: '<p>Date when the livestream ends',
                property: 'endDate',
    ...
    { title: 'Person', jsonld: personSchemaMarkup, schemaItems: [
            {
                required: true,
                info: '<p>Normally the city</p>',
                property: 'addressLocality',
                placeholder: 'This is Typically the city',
                title: 'City:',
                macro: '#addressCity',
                type: 'string'
            },
            {
                required: true,
                info: '<p>Normally this is the State abbreviation. Example: Ohio would be OH</p>',
            ...
            {
                required: true,
                info: '<p>The postal zipcode of for the address.</p>',
                property: 'postalCode',
            ...
            {
                required: true,
                info: '<p>Street address of the person.</p>',
    ...
    { title: 'Software', jsonld: software, schemaItems: [
            {
                required: true,
                info: '<p>Software Title</p>',
                property: 'name',
            ...
            {
                required: true,
                info: '<p>The operating systems the application can run on.</p>',
            ...
            {
                required: true,
                info: '<p>This is typically a number between 1 and 5. Decimals can be used. Example: 4.5</p>',
                property: 'ratingValue',
                placeholder: 'Rating Value',
                title: 'Rating Value:',
                macro: '#ratingValue',
            ...
            {
                required: true,
                info: '<p>The number of rating votes this application received, to determine the rating value above. Example: 4886 is four thousand eight hundred and eighty-six votes.</p>',
                property: 'ratingCount',
            ...
            {
                required: true,
                info: '<p>Price of the Application</p>',
                property: 'price',
                placeholder: 'The current price of the application',
                title: 'Price:',
                macro: '#price',
                type: 'string'
            },
            {
                required: true,
                info: '<p>The currency type. Example: USD</p>',
                property: 'priceCurrency',
    ...
    { title: 'Semantic-Tag', jsonld: semanticTags, schemaItems: [
            {
                required: true,
                info: '<p>Enter your keyword <strong>(name for this tag).</strong> We suggest one keyword ber semantic tag.</p>',
                property: 'keywords',
                placeholder: 'Keyword',
                title: 'Keyword:',
                macro: '#keywords',
            ...
            {
                required: true,
                info: '<p>A citation or reference to another creative work, such as another publication, web page, scholarly article, etc</p>',
                property: 'citation',
                placeholder: 'Citation - publication, web page, scholarly article, etc',
                title: 'Citation:',
                macro: '#citation',
                type: 'string'
            },
            {
                required: true,
                info: '<p>The URL of the citation source</p>',
                property: 'url',
                placeholder: 'URL of rthe citation source',
                title: 'URL:',
                macro: '#semurl',
                type: 'string'
            },
			{
                required: true,
                info: '<p>Add description for this semantic tag. For example, a  50 word FAQ type answer or useful summary to define this tag/topic.</p>',
                property: 'description',
                placeholder: 'Citation - publication, web page, scholarly article, etc',
                title: 'Description:',
                macro: '#description',
