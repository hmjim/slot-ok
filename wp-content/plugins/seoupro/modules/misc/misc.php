...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_Misc extends SU_Module {
		static function get_module_title() {
			return __( 'Miscellaneous', 'seo-ultimate-pro' );
		}
		...
		function admin_page_contents() {
			...
			echo '<p>' . __( 'The Miscellaneous page contains modules that don&#8217;t have enough settings to warrant their own separate admin pages.', 'seo-ultimate-pro' ) . '</p>';
