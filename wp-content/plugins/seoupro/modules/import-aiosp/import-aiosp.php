...
if ( class_exists( 'SU_ImportModule' ) ) {
	...
	class SU_ImportAIOSP extends SU_ImportModule {
		...
		static function get_module_title() {
			return __( 'Import from All in One SEO Pack', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'AIOSP Import', 'seo-ultimate-pro' );
		}

		function get_op_title() {
			return __( 'All in One SEO Pack', 'seo-ultimate-pro' );
		}

		function get_op_abbr() {
			return __( 'AIOSP', 'seo-ultimate-pro' );
		}

		function get_import_desc() {
			return __( 'Import post data (custom title tags and meta tags).', 'seo-ultimate-pro' );
		}
		...
		function admin_page_contents() {
			...
			echo "</p>\n<p>";
			_e( 'The import tool can only move over data from AIOSP version 1.6 or above. If you use an older version of AIOSP, you should update to the latest version first and run AIOSP&#8217;s upgrade process.', 'seo-ultimate-pro' );
			echo "</p>\n";
