...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_Autolinks extends SU_Module {
		static function get_module_title() {
			return __( 'Deeplink Juggernaut', 'seo-ultimate-pro' );
		}
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Content Links Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Content Link Settings Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
/*
			...
			,
				'title'   => __( 'Footer Links Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Footer Link Settings Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
