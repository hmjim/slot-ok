...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_WebmasterVerify extends SU_Module {
		...
		static function get_module_title() {
			return __( 'Webmaster Verification Assistant', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'W.M. Verification', 'seo-ultimate-pro' );
		}
		...
		function get_supported_search_engines() {
			return array(
				'google'    => array(
					'title'     => __( 'Google Webmaster Tools', 'seo-ultimate-pro' )
				,
					'meta_name' => 'google-site-verification'
				),
				'microsoft' => array(
					'title'     => __( 'Bing Webmaster Center', 'seo-ultimate-pro' )
				,
		...
		function admin_page_contents() {
			...
			$this->admin_wftable_start( array(
				'portal'          => __( 'Webmaster Portal', 'seo-ultimate-pro' )
			,
