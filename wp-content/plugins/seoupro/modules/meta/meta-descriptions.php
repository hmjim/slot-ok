...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_MetaDescriptions extends SU_Module {
		...
		static function get_module_title() {
			return __( 'Meta Description Editor', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'Meta Descriptions', 'seo-ultimate-pro' );
		}
		...
		function get_admin_page_tabs() {
			return array_merge(
				...
				,
					array(
						'title'    => __( 'Blog Homepage', 'seo-ultimate-pro' ),
						'id'       => 'su-blog-homepage',
						'callback' => 'home_tab'
					)
				)
			...
			,
				'label'             => __( 'Meta Description', 'seo-ultimate-pro' )
			) )
			);
		}
		...
		function formats_tab() {
			...
			$this->textboxes( array(
				'description_posttype_post'     => __( 'Post Description Format', 'seo-ultimate-pro' )
			,
				'description_posttype_page'     => __( 'Page Description Format', 'seo-ultimate-pro' )
			,
				'description_taxonomy_category' => __( 'Category Description Format', 'seo-ultimate-pro' )
			,
				'description_taxonomy_post_tag' => __( 'Post Tag Description Format', 'seo-ultimate-pro' )
			,
				'description_paged'             => __( 'Pagination Description Format', 'seo-ultimate-pro' )
		...
		function home_tab() {
			$this->admin_form_table_start();
			$this->textarea( 'home_description', __( 'Blog Homepage Meta Description', 'seo-ultimate-pro' ), 3 );
			$this->checkboxes( array(
				'home_description_tagline_default' => __( 'Use this blog&#8217s tagline as the default homepage description.', 'seo-ultimate-pro' )
			), __( 'Default Value', 'seo-ultimate-pro' ) );
			$this->admin_form_table_end();
		}
		...
		function postmeta_fields( $fields, $screen ) {
			...
			$fields['serp'][20]['description'] =
				"<div class='form-group su textarea'>\n<label class='col-sm-4 col-md-4 control-label' for='$id'>" . __( 'Meta Description:', 'seo-ultimate-pro' ) . "</label>\n<div class='col-sm-4 col-md-4'>"
				...
				. "</div>\n<div class='col-sm-4 col-md-4 help-text'>" . sprintf( __( 'You&#8217;ve Entered %s Characters. Most Search Engines Use Up To 140.', 'seo-ultimate-pro' ), "<strong id='su_meta_description_charcount'>" . strlen( $value ) . "</strong>" )
				. "</div>\n</div>\n";
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Blog Homepage Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
<ul>
	<li>
		...
		<p>Troubleshooting tip: Go to <a href='options-general.php?page=seo-ultimate'>Settings &rArr; SEO Ultimate+</a> and enable the &#8220;Identify the plugin&#8217;s HTML code insertions with HTML comment tags&#8221; option. This will mark SEO Ultimate Pro meta tags with comments, allowing you to see which meta tags are generated by SEO Ultimate Pro and which aren&#8217;t.</p>
	</li>
</ul>
", 'seo-ultimate-pro' )
			) );
