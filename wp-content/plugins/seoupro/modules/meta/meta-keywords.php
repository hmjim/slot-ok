...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_MetaKeywords extends SU_Module {
		...
		static function get_module_title() {
			return __( 'Meta Keywords Editor', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'Meta Keywords', 'seo-ultimate-pro' );
		}
		...
		function get_admin_page_tabs() {
			return array_merge(
				array(
					array(
						'title'    => __( 'Sitewide Values', 'seo-ultimate-pro' ),
						'id'       => 'su-sitewide-values',
						'callback' => 'global_tab'
					)
				,
					array(
			...
			,
				'label'             => __( 'Meta Keywords', 'seo-ultimate-pro' )
			) )
			);
		}
		...
		function global_tab() {
			...
			$this->textarea( 'global_keywords', __( 'Sitewide Keywords', 'seo-ultimate-pro' ) . '<br /><small><em>' . __( '(Separate with commas)', 'seo-ultimate-pro' ) . '</em></small>' );
		...
		function defaults_tab() {
			...
			foreach ( $posttypenames as $posttypename ) {
				...
				if ( post_type_supports( $posttypename, 'editor' ) ) {
					$checkboxes["auto_keywords_posttype_{$posttypename}_words"] = __( 'The %d most commonly-used words', 'seo-ultimate-pro' );
				}
		...
		function home_tab() {
			$this->admin_form_table_start();
			$this->textarea( 'home_keywords', __( 'Blog Homepage Meta Keywords', 'seo-ultimate-pro' ), 3 );
			$this->admin_form_table_end();
		}
		...
		function postmeta_fields( $fields, $screen ) {
			$fields['serp'][21]['keywords'] = $this->get_postmeta_textbox( 'keywords', __( 'Meta Keywords:<br /><em>(separate with commas)</em>', 'seo-ultimate-pro' ) );
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Sitewide Settings Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
<ul>
...
<ul>
	<li>
		...
		<p>Troubleshooting tip: Go to <a href='options-general.php?page=seo-ultimate'>Settings &rArr; SEO Ultimate+</a> and enable the &#8220;Insert comments around HTML code insertions&#8221; option. This will mark SEO Ultimate Pro meta tags with comments, allowing you to see which meta tags are generated by SEO Ultimate Pro and which aren&#8217;t.</p>
	</li>
</ul>
", 'seo-ultimate-pro' )
			) );
