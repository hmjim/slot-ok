...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_MetaRobots extends SU_Module {
		...
		static function get_module_title() {
			return __( 'Meta Robot Tags Editor', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'Meta Robot Tags', 'seo-ultimate-pro' );
		}
		...
		function global_tab() {
			...
			$this->checkboxes( array(
				'noarchive' => __( 'Don&#8217t cache or archive this site.', 'seo-ultimate-pro' )
			), __( 'Spider Instructions', 'seo-ultimate-pro' ) );
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Default Values Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Bulk Editor Tabs', 'seo-ultimate-pro' )
			,
				'content' => __( "
<ul>
