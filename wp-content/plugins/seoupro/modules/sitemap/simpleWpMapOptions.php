...
class SimpleWpMapOptions {
	...
	public function getSubmitUrl() {
		return 'admin.php?page=su-sitemap';
	}
	...
	public function pluginUrl() {
		return plugins_url() . '/seoupro/assets/img/';
	}

	// Returns default order option
	public function getDefaultOrder() {
		return array(
			'home'       => array( 'title' => 'Home', 'i' => 1 ),
			'posts'      => array( 'title' => 'Posts', 'i' => 2 ),
			'pages'      => array( 'title' => 'Pages', 'i' => 3 ),
			'other'      => array( 'title' => 'Other', 'i' => 4 ),
			'categories' => array( 'title' => 'Categories', 'i' => 5 ),
			'tags'       => array( 'title' => 'Tags', 'i' => 6 ),
			'authors'    => array( 'title' => 'Authors', 'i' => 7 )
		);
	}
	...
	public function setOptions( $otherUrls, $blockUrls, $attrLink, $categories, $tags, $authors, $orderArray, $activePage, $lastUpdated ) {
		...
		if ( $this->checkOrder( $orderArray ) && uasort( $orderArray, array(
				$this,
				'sortArr'
			) ) ) { // sort the array here
	...
	public function redirect() { ?>
        <h1>Successfully upgraded to SEO Ultimate Pro Premium!</h1>
