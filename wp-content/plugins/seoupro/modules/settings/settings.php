<?php
/**
 * SEO Ultimate Pro Plugin Settings Module
 *
 * @since 0.2
 */
...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_Settings extends SU_Module {
		...
		static function get_module_title() {
			if ( is_network_admin() ) {
				return __( 'Plugin Management', 'seo-ultimate-pro' );
			}

			return __( 'Plugin Settings', 'seo-ultimate-pro' );
		}

		function get_page_title() {
			if ( is_network_admin() ) {
				return __( 'SEO Ultimate Pro Plugin Management', 'seo-ultimate-pro' );
			}

			return __( 'SEO Ultimate Pro Plugin Settings', 'seo-ultimate-pro' );
		}

		static function get_menu_title() {
			return __( 'SEO Ultimate Pro', 'seo-ultimate-pro' );
		}
		...
		function add_help_tabs( $screen ) {
			...
			,
				'content' => __( "
<p>The Settings module lets you manage settings related to the SEO Ultimate Pro plugin as a whole.</p>
", 'seo-ultimate-pro' )
			) );
			...
			,
				'title'   => __( 'Global Settings', 'seo-ultimate-pro' )
			,
				'content' => __( "
<p>Here&#8217;s information on some of the settings:</p>
<ul>
	<li><strong>Identify the plugin&#8217;s HTML code insertions with HTML comment tags</strong> &mdash; If enabled, SEO Ultimate Pro will use HTML comments to identify all code it inserts into your <code>&lt;head&gt;</code> tag. This is useful if you&#8217;re trying to figure out whether or not SEO Ultimate Pro is inserting a certain piece of header code.</li>
