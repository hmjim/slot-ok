...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_UserCode extends SU_Module {
		...
		function admin_page_contents() {
			...
			$textareas = array(
				'wp_head'            => __( '&lt;head&gt; Tag', 'seo-ultimate-pro' )
			,
				'the_content_before' => __( 'Above Content', 'seo-ultimate-pro' )
			,
				'the_content_after'  => __( 'Below Content', 'seo-ultimate-pro' )
			,
				'wp_footer'          => __( 'Footer', 'seo-ultimate-pro' )
			);
		...
		function get_usercode( $field ) {
			...
			if ( is_front_page() ) {
				$code .= $this->get_setting( "frontpage_$field", '' );
			}

			return $this->plugin->mark_code( $code, __( 'Code Inserter module', 'seo-ultimate-pro' ), $field == 'wp_head' );
		}
