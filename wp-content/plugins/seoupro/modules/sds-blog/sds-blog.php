...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_SdsBlog extends SU_Module {
		...
		static function get_module_title() {
			return __( 'What&#39;s New', 'seo-ultimate-pro' );
		}
		...
		function get_page_title() {
			return __( 'SEO Design Solutions Whitepapers', 'seo-ultimate-pro' );
		}
		...
		function admin_page_contents() {
			...
			echo "<a href='http://www.seodesignsolutions.com'><img src='{$this->plugin->plugin_dir_url}assets/img/sds-logo.png' alt='" . __( 'SEO Design Solutions', 'seo-ultimate-pro' ) . "' id='sds-logo' /></a>";
			echo "<p>" . __( 'The search engine optimization articles below are loaded from the website of SEO Design Solutions, the company behind the SEO Ultimate Pro plugin. Click on an article&#8217;s title to read it.', 'seo-ultimate-pro' ) . "</p>\n";
			echo "<div class='rss-widget'>\n";

			add_filter( 'http_headers_useragent', 'su_get_user_agent' );
			add_filter( 'esc_html', array( &$this, 'truncate_at_ellipsis' ) );
			$this->sds_blog_rss_output( 'http://feeds.seodesignsolutions.com/SeoDesignSolutionsBlog', array(
				'show_summary' => 1,
				'show_date'    => 1,
				'items'        => 10
			) );
