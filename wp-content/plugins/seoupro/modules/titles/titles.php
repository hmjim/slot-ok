...
if ( class_exists( 'SU_Module' ) ) {
	...
	class SU_Titles extends SU_Module {
		...
		static function get_module_title() {
			return __( 'Title Tag Rewriter', 'seo-ultimate-pro' );
		}
		...
		function get_admin_page_tabs() {
			return array_merge(
				array(
					array(
						'title'    => __( 'Default Formats', 'seo-ultimate-pro' ),
						'id'       => 'su-default-formats',
						'callback' => 'formats_tab'
					)
				,
					array(
						'title'    => __( 'Settings', 'seo-ultimate-pro' ),
						'id'       => 'su-settings',
						'callback' => 'settings_tab'
					)
				)
...
", 'seo-ultimate-pro' )
			...
			$screen->add_help_tab( array(
				'id'      => 'su-titles-vars'
			,
				'title'   => __( 'Default Formats Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
...
", 'seo-ultimate-pro' )
			...
			,
				'title'   => __( 'Settings Tab', 'seo-ultimate-pro' )
			,
				'content' => __( "
	...
	<li>
		...
		<ul>
			<li><strong>Use output buffering</strong> &mdash; This is the &#8220;traditional&#8221; method that most SEO plugins use.
				With this method, SEO Ultimate Pro will intercept your site&#8217;s <code>&lt;head&gt;</code> tag section as it&#8217;s being outputted, 
				locate the <code>&lt;title&gt;</code> tag, edit its value, and then output the edited <code>&lt;head&gt;</code> data. 
				The good thing about this method is that you don&#8217;t have to edit your theme in any way, as SEO Ultimate Pro will overwrite 
			...
			<li>
				<p><strong>Use filtering</strong> &mdash; With this method, SEO Ultimate Pro will register itself with WordPress and will replace 
