...
akeeba.Fsfilters.activeTabRootChanged=function(){var a=document.getElementById("active_root");akeeba.Fsfilters.loadTab(a.options[a.selectedIndex].value)};akeeba.Fsfilters.load=function(a){a.verb="list";a=JSON.stringify(a);var b={};b.akaction=a;akeeba.System.doAjax(b,function(d){akeeba.Fsfilters.render(d)},null,!1,15E3)};
...
akeeba.Fsfilters.nuke=function(){var a={akaction:JSON.stringify({root:akeeba.Fsfilters.currentRoot,verb:"reset"})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.render(b)},null,!1,15E3)};akeeba.Fsfilters.loadTab=function(a){a={akaction:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(b){akeeba.Fsfilters.renderTab(b)},null,!1,15E3)};
